...
const Navbar = () => {
  ...
  return (
    <div className="absolute w-full flex justify-between p-4 items-center">
      <h1 className="text-white font-bold text-2xl z-20">Destinations.</h1>
      <BiMenu
        onClick={handleNav}
      ...
      >
        <ul className="flex flex-col fixed w-full h-full items-center justify-center">
          ...
          <li className="font-bold text-2xl p-8">Booking</li>
          <li className="font-bold text-2xl p-8">Destinations</li>
          <li className="font-bold text-2xl p-8">About Us</li>
        </ul>
      </div>
    </div>
  );
